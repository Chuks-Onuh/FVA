...
class MenuAdmin(admin.ModelAdmin):
    form = MenuAdminForm
    list_display = ['name', 'description', 'price', 'quantity', 'dateTimeCreated', 'vendorId', 'isRecurring', 'frequencyOfReocurence',]
...
class OrderAdmin(admin.ModelAdmin):
    form = OrderAdminForm
    list_display = ['customer', 'vendor',  'description', 'itemsOrdered', 'dateAndTimeOfOrder', 'amountDue', 
                'amountPaid', 'amountOutstanding', 'orderStatus', 'menu']
